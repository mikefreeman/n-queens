...
(function() {
  ...
  window.Board = Backbone.Model.extend({
    ...
    hasAnyQueensConflictsNoRows: function() {
 ...
 */
    ...
    hasMinorDiagonalConflictAt: function(minorDiagonalColumnIndexAtFirstRow) {
      ...
      if (minorDiagonalColumnIndexAtFirstRow === lastIndex) {
        rowIndex = 0;
        colIndex = lastIndex;
      } else if (minorDiagonalColumnIndexAtFirstRow < lastIndex) {
        rowIndex = 0;
        colIndex = minorDiagonalColumnIndexAtFirstRow;
      } else {
        colIndex = lastIndex;
        rowIndex = minorDiagonalColumnIndexAtFirstRow - lastIndex;
      }
